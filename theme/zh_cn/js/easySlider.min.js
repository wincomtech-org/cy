...
function(a, b, c, d) {
    ...
    a.extend(e.prototype, {
        ...
        paginate: function(b) {
            ...
            for (c = 1; c <= d; c++) a(this.settings.paginationClass + " li:nth-child(" + c.toString() + ")").removeClass("active");
            a(this.settings.paginationClass + " li:nth-child(" + b.toString() + ")").addClass("active"),
            this.slideParameters.setCurrentSlideNumber.call(this, b)
        },
        positionPagination: function() {
            var b = this.slideParameters.getNumberOfSlides.call(this),
            c = -(b * this.convertStringToInteger(this.settings.paginationDiameter) + (b - 1) * this.convertStringToInteger(this.settings.paginationSpacing)) / 6;
            a(this.settings.paginationClass).css("margin-left", c)
        },
        positionControls: function() {
            var b = (this.slideParameters.getSliderHeight.call(this) - this.slideParameters.getSlideHeight.call(this)) / 2,
            c = a(this.settings.controlsClass + " li").css("margin-top");
            a(this.settings.controlsClass + " li").css("margin-top", this.convertStringToInteger(c) - b + "px")
        },
        slideParameters: {
            ...
            getNumberOfSlides: function() {
                return a(this.settings.slidesClass).children().length
            },
            getSlideWidth: function() {
                return a(this.settings.slidesClass + " li").width()
            },
            getSlideHeight: function() {
                return a(this.settings.slidesClass + " li").height()
            },
            getSliderHeight: function() {
                return a(this.element).height()
            },
